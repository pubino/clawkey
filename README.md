...
LiteLLM translates Anthropic `tool_use` blocks ↔ OpenAI `function_call` so Claude Code's agent loop (file editing, code execution, tool use) works against Anthropic and non-Anthropic models.
